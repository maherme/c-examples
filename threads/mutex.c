/*
 * For compiling this code use "gcc -o mutex mutex.c -pthread"
 * You can see the assembler code using "gcc mutex.c -S" and check if count operations are atomic or not.
 */
#include <pthread.h>
#include <stdlib.h>
#include <stdio.h>
